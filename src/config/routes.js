...
module.exports = app => {
    ...
    app.route('/cliente-telemedicina')
        .all(app.src.config.passport.authenticate())
        .get(patient(app.src.api.role.patient.viewPatientTelemedicina))
    ...
    app.route('/cliente-lista-exames')
        .all(app.src.config.passport.authenticate())
        .get(patient(app.src.api.role.patient.viewPatientListaExames))
        .post(patient(app.src.api.role.patient.postPatientListaExames))
    ...
    app.route('/medico-lista-medicamentos')
        .get(app.src.api.role.doctor.viewDoctorListaMedicamentos)

    app.route('/medico-lista-pacientes')
        .get(app.src.api.role.doctor.viewDoctorListaPacientes)

    app.route('/medico-telemedicina')
        .get(app.src.api.role.doctor.viewDoctorTelemedicina)
