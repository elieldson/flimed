...
module.exports = app => {
    ...
    const viewPatientTelemedicina = (req, res) => {
        res.status(200).render('cliente-telemedicina', { message: null, user: req.session.user })
    }

    const viewPatientListaExames = (req, res) => {
        res.status(200).render('cliente-lista-exames', { page: 'Lista de Exames', message: null, user: req.session.user })
    }
    ...
    return {
        ...
        viewPatientHistory,
        viewPatientTelemedicina,
        viewPatientScheduling,
        viewPatientEvaluation,
        viewPatientListaExames
    }
}