...
romae = {
	...
	menuItem: () => {
		$(document).ready( () => {
			...
			} else if ($(".box__panel").hasClass("medico-contabilidade")) {
				$("ul.menu a[href='/medico-contabilidade']").addClass("active")
			} else if ($(".box__panel").hasClass("medico-historico")) {
				$("ul.menu a[href='/medico-historico']").addClass("active")
			}else if ($(".box__panel").hasClass("medico-resultado")) {
				$("ul.menu a[href='/medico-resultado']").addClass("active")
			}else if ($(".box__panel").hasClass("medico-marcar-consulta")) {
				$("ul.menu a[href='/medico-marcar-consulta']").addClass("active")
			}
...
$(document).ready(function(){
	$(".change-quest").on('change', function(){
		var selectValor = '.'+$(this).attr("id");
		$("#conennt-quest").children('div').hide();
		$("#conennt-quest").children(selectValor).show();
